...
def show_custom_message(title, message, bg_color="#ffffff"):
    ...
    # Header Label
    header = tk.Label(win, text=title, font=("Helvetica", 20, "bold"), bg=bg_color, fg="#222")
    header.pack(pady=20)
    ...
    # Message Text — increased width here
    msg = tk.Message(text_frame, text=message, font=("Helvetica", 14), bg=bg_color, fg="#333", width=750)
    msg.pack()
    ...
    ok_button = tk.Button(button_frame, text="OK", command=win.destroy, width=16, height=2, 
                          font=("Helvetica", 14, "bold"), bg="#4caf50", fg="white", relief="raised", bd=3)
    ok_button.pack()
